...
namespace Web_Library.Data.Migrations
{
    ...
    [Migration("20260213000849_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Library.Data.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Web_Library.Data.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Web_Library.Data.Models.UserBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_Library.Data.Models.UserBook", b =>
                {
                    b.HasOne("Web_Library.Data.Models.Book", "Book")
                        .WithMany("BookUsers")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_Library.Data.Models.User", "User")
                        .WithMany("UserBooks")
